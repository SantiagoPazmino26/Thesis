...
/**
 * @author Santiago Pazmino santiago.d.pinto[at]student.fh-kiel.de
 *
 */
public class AddDataNetworkActionDelegate extends RightsEnabledActionDelegate implements IViewActionDelegate, RightEnabledUserInteraction{
    ...
    public void doRun(IAction action) {
        try {
            ...
            newElement = CnAElementFactory.getInstance().saveNew(
                    CnAElementFactory.getInstance().getDataProtectionModel(),
                    DataNetwork.TYPE_ID, null, false);
            if (newElement != null) {
                EditorFactory.getInstance().openEditor(newElement);
            }
        } catch (Exception e) {
            ExceptionUtil.log(e, Messages.AddDataNetworkDelegate_0);
        }
