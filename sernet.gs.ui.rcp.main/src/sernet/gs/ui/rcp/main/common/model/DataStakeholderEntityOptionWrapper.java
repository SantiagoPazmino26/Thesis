...
public class DataStakeholderEntityOptionWrapper implements IMLPropertyOption {

    private static final long serialVersionUID = 1L;

    private Entity stakeholder;

	public DataStakeholderEntityOptionWrapper(Entity entity) {
	...
	public String getId() {
		return stakeholder.getDbId().toString();
	}

	public String getName() {
		return DataStakeholder.getTitel(stakeholder);
	}
