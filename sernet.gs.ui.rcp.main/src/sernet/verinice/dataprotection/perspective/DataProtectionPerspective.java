package sernet.verinice.dataprotection.perspective;
...
import sernet.verinice.dataprotection.catalog.CatalogView;
...
//	private static final float RATIO_DETAILS_FOLDER = 0.5f;
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		modelFolder.addView(DataProtectionView.ID);
		modelFolder.addPlaceholder(DataProtectionView.ID + ":*");
		layout.getViewLayout(DataProtectionView.ID).setCloseable(true);
