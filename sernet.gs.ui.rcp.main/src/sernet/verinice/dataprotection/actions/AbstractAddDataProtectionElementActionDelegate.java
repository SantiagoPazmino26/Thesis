...
/**
 * A base class for adding new Data Protection elements to an element group.
 * 
 ...
 *
 */
public abstract class AbstractAddDataProtectionElementActionDelegate<T extends CnATreeElement>
        extends AbstractAddCnATreeElementActionDelegate {

    protected IWorkbenchPart targetPart;
    private final Class<? extends CnATreeElement> elementGroupClass;
    private final String typeId;
    private final String failureMessage;

    public AbstractAddDataProtectionElementActionDelegate(Class<? extends CnATreeElement> elementGroupClass,
